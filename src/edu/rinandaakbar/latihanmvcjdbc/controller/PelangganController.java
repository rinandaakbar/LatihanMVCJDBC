 ...
 */
package edu.rinandaakbar.latihanmvcjdbc.controller;

import edu.rinandaakbar.latihanmvcjdbc.model.PelangganModel;
import edu.rinandaakbar.latihanmvcjdbc.view.PelangganView;
...
public class PelangganController {
    ...
    public void updatePelanggan(PelangganView view) {
        ...
        if (nama.trim().equals("")) {
            ...
            JOptionPane.showMessageDialog(view, "Nomor telepon tida boleh lebih dari 12 digit");
        } else if (!email.contains("@") || !email.contains(".")) {
            JOptionPane.showMessageDialog(view, "Email Tidak Valid");
        } else {
